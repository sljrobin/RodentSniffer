...
int rosn_boot_args_manage(int argcnt, char *argvctr[])
{
    ...
    rosn_utils_clrprnt_setattr(rosn_utils_clrprnt_setfg(rosn_utils_clrprnt_init(&ptarg_error), ROSN_CLR_RED), ROSN_ATTR_NONE); /* Argument error */
